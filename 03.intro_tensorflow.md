...
#### 2. 反向传播
![](readme/tensorflow反向传播.jpg)

#### 3. tensorflow 执行子图
* tensorflow 支持单独执行子图，用户可以选择计算图的任意子图，并沿某些边输入数据，同时从另一些边获取输出结果，

![](readme/TensorFlow执行子图.png)


#### 4. tensorboard

![](readme/tensorboard.png)
...
![](readme/不同数字可能对应特征权重.png)
![](readme/softmax_计算公式.png)
![](readme/tensorflow_手写体识别_loss.png)
![](readme/tensorflow_手写体识别_优化.png)

![](readme/tensorflow_手写体识别_整体流.JPG)
