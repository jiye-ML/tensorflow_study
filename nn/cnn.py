...
if __name__ == '__main__':
    ...
    output = "name={},epochs={},batch_size={},type_number={},image_size={},image_channel={},zip_file={},keep_prob={}"
    ...
    net = AlexNet(now_data.type_number, now_data.image_size, now_data.image_channel, now_data.batch_size)

    runner = Runner(data=now_data, classifies=net.alex_net, learning_rate=0.0001, keep_prob=args.keep_prob)
